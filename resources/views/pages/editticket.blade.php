...
<div class="container">
    {{-- Edit Ticket --}}
    <div class="modal fade modal-md" id="viewticketsModal" tabindex="-1" aria-labelledby="addUserModal" aria-hidden="true" aria-modal="true">
...
.required-field::after {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Open Modal 1
            document.getElementById('openviewtickets').addEventListener('click', function() {
                var addUserModal = new bootstrap.Modal(document.getElementById('viewticketsModal'));
                addUserModal.show();
            });
        });
    </script>